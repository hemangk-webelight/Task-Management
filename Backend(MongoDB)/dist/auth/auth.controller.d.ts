...
export declare class AuthController {
    ...
    sendMailForPassword(credentials: Partial<LoginCredentialsDto>, res: Response): Promise<Response<any, Record<string, any>>>;
    changePassword(credential: LoginCredentialsDto, res: Response): Promise<Response<any, Record<string, any>>>;
}
